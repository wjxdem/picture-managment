...
<header class="pg-header">
	<div class="pull-left">
		...
		<ul class="top-nav">
			...
			<li class="current"><a href="img-manage.php">架构图素材管理</a></li>
                ...
                <div class="panel-body">
                    ...
                    <div class="js-add-wrap form-horizontal hide">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="pid" name="pid" class="js-select-scate" >
                    ...
                    <form class="form-horizontal" id="search-form" action="./imgpage.php" method="post">
    ...
    <script src="scripts/imgManagePage.js"></script>
    <script type="text/javascript">
    window.globalConfig = {
        api: {
            deleteImg: 'adminAction.php?act=delmaterialphoto',
            getSubClassify:'ajaxaction.php?act=getselection'
        }

    }
    new pg.admin.ImgManagePage();
    </script>
